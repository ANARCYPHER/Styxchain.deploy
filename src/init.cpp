    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Litecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  styxchaind [options]                     " + "\n" +
                  "  styxchaind [options] <command> [params]  " + _("Send command to -server or styxchaind") + "\n" +
                  "  styxchaind [options] help                " + _("List commands") + "\n" +
                  "  styxchaind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "styxchain:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: styxchain.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: styxchaind.pid)") + "\n" +
