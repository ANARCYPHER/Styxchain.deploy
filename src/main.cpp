...
uint256 hashGenesisBlock("0xa3a7ce519512e390e1fe4e4564bd1d851b86587a170e8dbf581da49b20d177ff");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Styxchain: starting difficulty is 1 / 2^12
...
{
    int64 nSubsidy = 50 * COIN; //int64 nSubsidy = 50 * COIN; Styxchain Line 1090***

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 840000); // Styxchain: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Styxchain: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Styxchain: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe15ab9bb2ce5dc7ddfc9275c5a7941b8eb1efc44b3d9983b075fdef4f23c2c45");      
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Stand Still Stay Silent";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN; //Line 2787***
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0464fb3228e4a47e601b5034e81f54642ee04fee929868cb7d550b8ebaed8953c76fced33a145e0c12f50837db83aa4e790303f9e26f6a82802521b2be6f54bffc") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1612706986;   //line 2794*** terminal date +%s
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086590425;

        if (fTestNet)
        {
            block.nTime    = 1612706836; //2800*** terminal date +%s
            block.nNonce   = 385701881;
        } 
        ////paste code here!line 2803*** under fTestNet
        ...
        assert(block.hashMerkleRoot == uint256("0x58fe7a8022a830cdeb8495fac59ccc292fc11f58902ca3c6ff7931d6e4c573d9"));
        block.print();
