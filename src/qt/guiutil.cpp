...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("styxchain"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("styxchain://"))
    {
        uri.replace(0, 11, "styxchain:");
    }
...
{
    return GetAutostartDir() / "styxchain.desktop";
}
    ...
    QMessageBox(parent)
{
    header = tr("Litecoin-Qt") + " " + tr("version") + " " +
        ...
        tr("Usage:") + "\n" +
        "  styxchain-qt [" + tr("command-line options") + "]                     " + "\n";
