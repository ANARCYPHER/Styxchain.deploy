    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText2   = QChar(0xA9)+QString(" 2021-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Styxchain developers"));
    QString copyrightText3 = QChar(0xA9)+QString(" %1 ").arg(2021) + QString(tr("STYXCHAIN"));
    QString font            = "Arial";
